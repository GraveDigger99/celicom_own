(() => {
    ...
    (() => {
        ...
        const calendar = document.querySelector("[data-datepicker]");
        const calendarSecond = document.querySelector("[data-datepicker2]");
        if (calendar) {
        ...
        const script_showMore = document.querySelector(".questions__more");
        if (script_showMore) {
            const spollersLength = document.querySelectorAll(".spollers__item").length;
            let items = 6;
            script_showMore.addEventListener("click", (() => {
                items += 3;
                const array = Array.from(document.querySelector(".questions__spollers").children);
        ...
        const stepperSubmit = document.querySelector(".card__submit");
        const stepperInner = document.querySelector(".stepper__inner");
        const lastStepper = document.querySelector(".last-stepper");
        if (stepperSubmit) stepperSubmit.addEventListener("click", (() => {
            stepperInner.style.display = "none";
            lastStepper.style.display = "block";
        }));
        const filterAllBtn = document.querySelector(".filter-button_all");
        const filterBtn1 = document.querySelector(".filter-button_1");
        const filterBtn2 = document.querySelector(".filter-button_2");
        const filterBtn3 = document.querySelector(".filter-button_3");
        const filterBtn4 = document.querySelector(".filter-button_4");
        const filterBtn5 = document.querySelector(".filter-button_5");
        const filterBtn6 = document.querySelector(".filter-button_6");
        const filterBtn7 = document.querySelector(".filter-button_7");
        const filterBtn8 = document.querySelector(".filter-button_8");
        let filteritems = document.querySelectorAll(".filter-portfolio__item");
        const filterBtns = document.querySelectorAll("[data-f]");
        if (filterAllBtn || filterBtn1 || filterBtn2 || filterBtn3 || filterBtn4 || filterBtn5 || filterBtn6 || filterBtn7 || filterBtn8) {
            filterBtn1.addEventListener("click", (event => {
                filterAllBtn.classList.remove("active-filter-button");
                let activeBtns = [];
                let filterBtnId1 = event.target.dataset["f"];
                filterBtn1.classList.toggle("active-filter-button");
                filteritems.forEach((filterItem => {
                    if (filterItem.classList.contains(filterBtnId1) && event.target.classList.contains("active-filter-button")) filterItem.classList.add("hide-element"); else filterItem.classList.remove("hide-element");
                }));
                filterBtns.forEach((filterBtn => {
                    if (filterBtn.classList.contains("active-filter-button")) {
                        console.log(filterBtn);
                        activeBtns.push(filterBtn.dataset["f"]);
                    }
                }));
                console.log("button-1", activeBtns);
                activeBtns.forEach((activeButton => {
                    filteritems.forEach((filterItem => {
                        if (filterItem.classList.contains(activeButton)) filterItem.classList.add("hide-element");
                    }));
                    console.log(activeButton);
                }));
            }));
            filterBtn2.addEventListener("click", (event => {
                filterAllBtn.classList.remove("active-filter-button");
                let activeBtns = [];
                let filterBtnId2 = event.target.dataset["f"];
                filterBtn2.classList.toggle("active-filter-button");
                filteritems.forEach((filterItem => {
                    if (filterItem.classList.contains(filterBtnId2) && event.target.classList.contains("active-filter-button")) filterItem.classList.add("hide-element"); else filterItem.classList.remove("hide-element");
                }));
                filterBtns.forEach((filterBtn => {
                    if (filterBtn.classList.contains("active-filter-button")) {
                        console.log(filterBtn);
                ...
                console.log("button-2", activeBtns);
                activeBtns.forEach((activeButton => {
                    filteritems.forEach((filterItem => {
                        if (filterItem.classList.contains(activeButton)) filterItem.classList.add("hide-element");
                    }));
            ...
            filterBtn3.addEventListener("click", (event => {
                filterAllBtn.classList.remove("active-filter-button");
                let activeBtns = [];
                let filterBtnId3 = event.target.dataset["f"];
                filterBtn3.classList.toggle("active-filter-button");
                filteritems.forEach((filterItem => {
                    if (filterItem.classList.contains(filterBtnId3) && event.target.classList.contains("active-filter-button")) filterItem.classList.add("hide-element"); else filterItem.classList.remove("hide-element");
                }));
                filterBtns.forEach((filterBtn => {
                    if (filterBtn.classList.contains("active-filter-button")) {
                        console.log(filterBtn);
            ...
            filterBtn4.addEventListener("click", (event => {
                filterAllBtn.classList.remove("active-filter-button");
                let activeBtns = [];
                let filterBtnId4 = event.target.dataset["f"];
                filterBtn4.classList.toggle("active-filter-button");
                filteritems.forEach((filterItem => {
                    if (filterItem.classList.contains(filterBtnId4) && event.target.classList.contains("active-filter-button")) filterItem.classList.add("hide-element"); else filterItem.classList.remove("hide-element");
                }));
                filterBtns.forEach((filterBtn => {
                    if (filterBtn.classList.contains("active-filter-button")) {
                        console.log(filterBtn);
            ...
            filterBtn5.addEventListener("click", (event => {
                filterAllBtn.classList.remove("active-filter-button");
                let activeBtns = [];
                let filterBtnId5 = event.target.dataset["f"];
                filterBtn5.classList.toggle("active-filter-button");
                filteritems.forEach((filterItem => {
                    if (filterItem.classList.contains(filterBtnId5) && event.target.classList.contains("active-filter-button")) filterItem.classList.add("hide-element"); else filterItem.classList.remove("hide-element");
                }));
                filterBtns.forEach((filterBtn => {
                    if (filterBtn.classList.contains("active-filter-button")) {
                        console.log(filterBtn);
            ...
            filterBtn6.addEventListener("click", (event => {
                filterAllBtn.classList.remove("active-filter-button");
                let activeBtns = [];
                let filterBtnId6 = event.target.dataset["f"];
                filterBtn6.classList.toggle("active-filter-button");
                filteritems.forEach((filterItem => {
                    if (filterItem.classList.contains(filterBtnId6) && event.target.classList.contains("active-filter-button")) filterItem.classList.add("hide-element"); else filterItem.classList.remove("hide-element");
                }));
                filterBtns.forEach((filterBtn => {
                    if (filterBtn.classList.contains("active-filter-button")) {
                        console.log(filterBtn);
            ...
            filterBtn7.addEventListener("click", (event => {
                filterAllBtn.classList.remove("active-filter-button");
                let activeBtns = [];
                let filterBtnId7 = event.target.dataset["f"];
                filterBtn7.classList.toggle("active-filter-button");
                filteritems.forEach((filterItem => {
                    if (filterItem.classList.contains(filterBtnId7) && event.target.classList.contains("active-filter-button")) filterItem.classList.add("hide-element"); else filterItem.classList.remove("hide-element");
                }));
                filterBtns.forEach((filterBtn => {
                    if (filterBtn.classList.contains("active-filter-button")) {
                        console.log(filterBtn);
            ...
            filterBtn8.addEventListener("click", (event => {
                filterAllBtn.classList.remove("active-filter-button");
                let activeBtns = [];
                let filterBtnId8 = event.target.dataset["f"];
                filterBtn8.classList.toggle("active-filter-button");
                filteritems.forEach((filterItem => {
                    if (filterItem.classList.contains(filterBtnId8) && event.target.classList.contains("active-filter-button")) filterItem.classList.add("hide-element"); else filterItem.classList.remove("hide-element");
                }));
                filterBtns.forEach((filterBtn => {
                    if (filterBtn.classList.contains("active-filter-button")) {
                        console.log(filterBtn);
            ...
            filterAllBtn.addEventListener("click", (event => {
                ...
                filterAllBtn.classList.remove("active-filter-button");
                filteritems.forEach((filterItem => {
                    filterItem.classList.remove("hide-element");
                }));
                filterBtns.forEach((filterBtn => {
                    filterBtn.classList.remove("active-filter-button");
                }));
                filterAllBtn.classList.add("active-filter-button");
            }));
        }
        window["FLS"] = false;
        isWebp();
